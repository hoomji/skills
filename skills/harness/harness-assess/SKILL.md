...
task runner, CI, architecture/domain docs, indexed design docs, ADRs, knowledge-store
indexes and whether their entries still resolve, representative tests, observability
setup, hooks, and worktree/background conventions. Follow pointers that materially affect a
